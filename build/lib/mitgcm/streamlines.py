...
def quadralinear_interp(x0,y0,z0,t0,netcdf_filename,variable,x,y,z,t,len_x,len_y,len_z,len_t):
  ...
  field_interp = actual_quadralinear_interp(field,x0,y0,z0,t0,x_index,y_index,z_index,t_index,x,y,z,t)
